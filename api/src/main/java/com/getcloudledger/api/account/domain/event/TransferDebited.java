...
@NoArgsConstructor
public class TransferDebited extends DomainEvent {

    private BigDecimal amount;
    private UUID counterpartAccountId;
    private UUID transferId;

    public TransferDebited(UUID aggregateId, UUID accountId, BigDecimal amount,
    ...
    public TransferDebited(UUID aggregateId, UUID accountId, UUID eventId, String occurredOn,
    ...
    @Override
    public TransferDebited fromPrimitives(UUID aggregateId, UUID accountId, HashMap<String, Object> body,
