...
public class TransferCredited extends DomainEvent implements BalanceAware {
    ...
    public TransferCredited(UUID aggregateId, String ownerId, BigDecimal amount,
    ...
    public TransferCredited(UUID aggregateId, String ownerId, UUID eventId, String occurredOn,
    ...
    @Override
    public TransferCredited fromPrimitives(UUID aggregateId, String ownerId, HashMap<String, Object> body,
