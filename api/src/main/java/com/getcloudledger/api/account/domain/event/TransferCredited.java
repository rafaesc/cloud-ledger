...
public class TransferCredited extends DomainEvent implements BalanceAware {
    ...
    public TransferCredited(UUID aggregateId, UUID userId, BigDecimal amount,
    ...
    public TransferCredited(UUID aggregateId, UUID userId, UUID eventId, String occurredOn,
    ...
    @Override
    public TransferCredited fromPrimitives(UUID aggregateId, UUID userId, HashMap<String, Object> body,
